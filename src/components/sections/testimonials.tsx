              ...
              {testimonials.map((testimonial, index) => (
                <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                  <div className="p-4 h-full">
                    <Card className="h-full flex flex-col justify-between shadow-lg rounded-lg transition-shadow duration-300 hover:shadow-xl bg-card/80">
                      <CardContent className="p-6 flex-grow">
                        <blockquote className="italic text-muted-foreground border-l-4 border-primary pl-4">
                          "{testimonial.quote}"
                        </blockquote>
                      </CardContent>
                      <div className="p-6 bg-muted/20 flex items-center gap-4">
