...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Big Costa Construction (Private) Limited - Quality & Professionalism',
    template: `%s | Big Costa Construction (Private) Limited`,
  },
  ...
  openGraph: {
    ...
    description: 'Leading construction services in Sri Lanka for residential, commercial, and industrial projects.',
